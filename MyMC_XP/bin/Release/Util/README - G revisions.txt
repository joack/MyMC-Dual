...
If you don't, then surely that will be when this all catestrophically fails and deletes all your saves.
...
possible issues:
  ...
  - My creation of EXE from the python source doesn't have the hooks worked out yet to diplay the icon graphics. 
